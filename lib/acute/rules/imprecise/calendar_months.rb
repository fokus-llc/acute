...
module Acute::Rules::Imprecise
  module CalendarMonths
    ...
    module ImpreciseFractionalMonthOfYear1
      def precise_fractional_month?; false; end
  ...
  class CalendarMonthsParser < Treetop::Runtime::CompiledParser
    include CalendarMonths
  end
